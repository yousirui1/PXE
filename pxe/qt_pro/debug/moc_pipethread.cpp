...
void PipeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        PipeThread *_t = static_cast<PipeThread *>(_o);
        switch (_id) {
        case 0: _t->close_pipe(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData PipeThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PipeThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_PipeThread,
      qt_meta_data_PipeThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PipeThread::getStaticMetaObject() { return staticMetaObject; }
